...
def detect(img):
    model=keras.models.load_model("C:\\Users\\User\\anaconda3\\Simbolo\\project\\model3_maskdataall.h5")
...
def main():
    ...
    sidebarImg=Image.open(r'D:\photos\download (2).jpg')
    st.sidebar.image(sidebarImg)
    choice=st.sidebar.selectbox('Menu',menu)
    
    if choice == 'Home':
        st.header('Welcome to the app!')
        homeImg=Image.open(r'D:\photos\face-mask-emoji-concept-illustration_114360-6244.jpg')
        st.image(homeImg)
